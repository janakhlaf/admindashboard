...
def admin_upload_asset(data: AdminAssetCreate, db: Session = Depends(get_db)):
    ...
    return {"message": "Admin asset uploaded and approved successfully", "asset": new_asset}
...
def admin_upload_film(data: AdminFilmCreate, db: Session = Depends(get_db)):
    ...
    return {"message": "Admin film uploaded and approved successfully", "film": new_film}
...
def update_film(film_id: int, data: FilmUpdate, db: Session = Depends(get_db)):
    ...
    return {"message": "Film updated successfully", "film": film}
